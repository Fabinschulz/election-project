...
def show_Result_Vereadores(vereador_Piu_Piu, vereador_Hector,vereador_Frajola, vereador_Vovo, vereador_Bulldog,
    ...
    print(f'candidato a vereador Hector - teve {vereador_Hector} votos \n')
    print(f'candidato a vereador Frajola - teve {vereador_Frajola} votos \n')
    print(f'candidato a vereador Vovó - teve {vereador_Vovo} votos \n')
    print(f'candidato a vereador Bulldog - teve {vereador_Bulldog} votos \n')
    print(f'candidato a vereador Papa-Léguas - teve {vereador_Papa_Leguas} votos \n')
    print(f'candidato a vereador Coiote - teve {vereador_Coiote} votos \n')
